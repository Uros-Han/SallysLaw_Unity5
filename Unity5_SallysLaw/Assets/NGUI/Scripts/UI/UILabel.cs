...
public class UILabel : UIWidget
{
	...
	void SwitchFont(FontType font)
	{
		if (transform.parent.parent.name.Equals ("LanguagePanel")) {
			return;
		}
		
		switch (font) {
		case FontType.SystemFont:
			trueTypeFont = Resources.GetBuiltinResource<Font> ("Arial.ttf");
			break;
			
		case FontType.Londrina:
			trueTypeFont = Resources.Load ("LondrinaSolid-Regular") as Font;
			break;
			
		case FontType.Jua:
			trueTypeFont = Resources.Load ("BMJUA_ttf") as Font;
			break;

		case FontType.GenJyuu:
			trueTypeFont = Resources.Load ("GenJyuuGothic-Heavy") as Font;
			break;
		}
	}
