...
//    NSDictionary *receiptDict = [NSDictionary dictionaryWithContentsOfURL:[[NSBundle mainBundle] appStoreReceiptURL]];
//    NSDictionary *receiptDict       = [self getStoreReceipt:true];
