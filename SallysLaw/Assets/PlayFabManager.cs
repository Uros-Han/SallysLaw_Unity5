...
public class PlayFabManager : MonoBehaviour {
	...
	private Dictionary<string, UserDataRecord> playerData = new Dictionary<string, UserDataRecord>();
	private List<StatisticValue> playerStats = new List<StatisticValue>();
	...
	public string GetDataValueForKey(string key) {
		string value = "empty";//we return "empty" if that data doesn't exist on the server for this player
